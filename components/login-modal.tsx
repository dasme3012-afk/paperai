...
export function LoginModal({ isOpen, onClose }: Props) {
  ...
  const GoogleButton = ({ label }: { label: string }) => (
    <button
      ...
      disabled={loading}
      className="flex w-full items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm font-bold hover:bg-white/10 disabled:opacity-50 transition-all duration-200 cursor-pointer"
    >
  ...
  // ── Divider ──
  const Divider = () => (
    <div className="my-4 flex items-center text-xs text-white/30">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md">
      ...
      <section className="relative w-full max-w-xs rounded-2xl border border-white/10 bg-[#151525] p-5 shadow-2xl text-white animate-in fade-in zoom-in-95 duration-200">
        ...
        {view === "sign-in" && (
          <>
            <div className="text-center mb-4">
              <div className="inline-flex items-center mb-3 select-none">
