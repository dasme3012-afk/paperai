...
export default function LoginPage() {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-paper px-5 text-ink dark:bg-[#101113] dark:text-paper">
      <section className="w-full max-w-md rounded-lg border border-line bg-white p-6 shadow-page dark:border-white/10 dark:bg-white/5">
        <div className="text-center mb-6">
          <Link href="/" className="text-2xl font-black text-brand">PaperAI</Link>
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          <div>
            <label className="block text-xs font-bold" htmlFor="email">Email address</label>
            <input
              id="email"
              value={email}
          ...
          <div>
            <label className="block text-xs font-bold" htmlFor="password">Password</label>
            <input
              id="password"
              value={password}
