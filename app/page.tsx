        ...
        <div className="hidden md:flex flex-1 items-center justify-center gap-6 text-sm font-semibold text-white/70">
          ...
          <div className="relative group cursor-pointer py-2">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 w-44 rounded-xl border border-white/10 bg-[#121220] p-1.5 shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              <Link href="/tools?tool=pdf-to-jpg" className="block rounded-lg px-3 py-1.5 text-xs font-bold text-white/70 hover:text-white hover:bg-white/5">PDF to JPG</Link>
              <Link href="/tools?tool=jpg-to-pdf" className="block rounded-lg px-3 py-1.5 text-xs font-bold text-white/70 hover:text-white hover:bg-white/5">JPG to PDF</Link>
              <Link href="/tools?tool=merge-pdf" className="block rounded-lg px-3 py-1.5 text-xs font-bold text-white/70 hover:text-white hover:bg-white/5">Merge PDF</Link>
              <Link href="/tools?tool=split-pdf" className="block rounded-lg px-3 py-1.5 text-xs font-bold text-white/70 hover:text-white hover:bg-white/5">Split PDF</Link>
              <Link href="/tools?tool=rotate-pdf" className="block rounded-lg px-3 py-1.5 text-xs font-bold text-white/70 hover:text-white hover:bg-white/5">Rotate PDF</Link>
              <div className="my-1 h-px bg-white/5" />
              <Link href="/tools?tool=image-resizer" className="block rounded-lg px-3 py-1.5 text-xs font-bold text-white/70 hover:text-white hover:bg-white/5">Image Resizer</Link>
              ...
              <Link href="/tools?tool=convert-to-jpg" className="block rounded-lg px-3 py-1.5 text-xs font-bold text-white/70 hover:text-white hover:bg-white/5">Convert to JPG</Link>
              <Link href="/tools?tool=convert-from-jpg" className="block rounded-lg px-3 py-1.5 text-xs font-bold text-white/70 hover:text-white hover:bg-white/5">Convert from JPG</Link>
